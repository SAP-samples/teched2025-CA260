...
3. Select the application type `Full-Stack Node.JS`
    ...
    <p align="center"><img src="./images/ex1_01_01.png" width="65%" /><img src="./images/ex1_01_02.png" width="65%" /></p>
...
4. Click `Next` and fill out the form fields
    ...
    <p align="center"><img src="./images/ex1_01_03.png" width="65%" /></p>

> [!CAUTION]
> Make sure to replace `###` with your participant number.  
> For example participant number `1` results in `CA260-001`

5. Click `Review` and complete the creation of the project.
...
3. Enter the following command and hit *Enter* to install the packages, that are required for building our application:
    ...
    <p align="center"><img src="./images/ex1_02_01.png" width="65%" /><img src="./images/ex1_02_02.png" width="65%" /></p>
...
7. Right click the *.mtar* file and select `Deploy MTA Archive`.
    ...
    <p align="center"><img src="./images/ex1_02_03.png" width="65%" /><img src="./images/ex1_02_04.png" width="65%" /></p>
...
10. Click on the *Copy* icon next to the *Temporary Authentication Code* that shows after successfully logging in.
    ...
    <p align="center"><img src="./images/ex1_02_05.png" width="65%" /><img src="./images/ex1_02_06.png" width="65%" /></p>
...
12. Select the *organization* `ca260` and the *space* `CA260` as *Cloud Foundry Target*, to which we will deploy our application.  
    ...
    <p align="center"><img src="./images/ex1_02_07.png" width="65%" /><img src="./images/ex1_02_08.png" width="65%" /></p>
...
<p align="center"><img src="./images/ex1_summary_01.png" width="65%" /></p>
...
> <p align="center"><img src="./images/ex1_summary_02.png" width="65%" /></p>
> <p align="center"><img src="./images/ex1_summary_03.png" width="65%" /></p>
> 
...
<p align="center"><img src="./images/ex1_summary_04.png" width="65%" /></p>
<p align="center"><img src="./images/ex1_summary_05.png" width="65%" /></p>
